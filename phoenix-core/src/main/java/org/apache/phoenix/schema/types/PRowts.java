...
public class PRowts extends PWholeNumber<PRowts> {
    public static final PRowts INSTANCE = new PRowts();

    private PRowts() {
        super("ROW_TS", Types.BIGINT, PRowts.class,new PRowts.LongCodec(), 48);
    }
    ...
    public Object toObject(Object object, PDataType actualType) {
        ...
        if (equalsAny(actualType, PLong.INSTANCE, PUnsignedLong.INSTANCE)) {
            ...
            return date.getTime();
        } else if (equalsAny(actualType, PRowts.INSTANCE)) {
            return object;
        }
